...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    postRequest({
      ...
      .then((res) => {
        ...
        setCookie('IPD', res?.data?.accessToken, 30)
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, #0b3f76 0%, #1a5fa8 50%, #0b3f76 100%)',
      }}
    >
          ...
          <div className="col-md-6 col-lg-4">
            ...
            >
              ...
              <div
                style={{
                  height: '4px',
                  background: 'linear-gradient(to right, #0b3f76, #1a5fa8, #0b3f76)',
                }}
              />
              ...
              <div className="card-body p-4 p-md-5 bg-white">
                ...
                <div className="text-center mb-4">
                  ...
                  <h5
                    ...
                    style={{ color: '#0b3f76', fontSize: '1rem', letterSpacing: '0.01em' }}
                  >
                ...
                <h6 className="fw-semibold mb-4 text-dark" style={{ fontSize: '1rem' }}>
                  Sign In
                </h6>
